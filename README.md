...
* Get a Tang Primer 25K with 4 modules: Tang sdram, dvi, ds2 and sd, with the modules plugged in as follows (pmod positions are important as pins are fixed), <br><img src="doc/images/primer25k_setup.jpg" width=400 />
...
The project is still in early stages and some games do not work. Here are a few games that work for me: Super Mario World, Gradius III, Contra III and MegaMan X. Find more on the [game compatibility page](/nand2mario/snestang/wiki/Game-Compatibility).
...
* [SNES_FPGA](https://github.com/gyurco/SNES_FPGA) for MiSTer and MIST by Sergiy Dvodnenko (srg320) and gyurco.
