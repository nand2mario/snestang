...
# set_multicycle_path 2 -hold -start -from [get_nets {cpu_port*}] -to [get_clocks {wclk}]
# set_multicycle_path 3 -setup -start -from [get_nets {bsram_dout*}] -to [get_clocks {wclk}]
# set_multicycle_path 2 -hold -start -from [get_nets {bsram_dout*}] -to [get_clocks {wclk}]
# set_multicycle_path 3 -setup -start -from [get_nets {rv_dout*}] -to [get_clocks {wclk}] 
# set_multicycle_path 2 -hold -start -from [get_nets {rv_dout*}] -to [get_clocks {wclk}] 
// sdram to SMP
